...
- карта храма — `700043`;
- фрагменты королевского сокровища — `700036`, `/img/antiques/royal-treasure-fragments.png`;
- фрагменты небесного сокровища — `700035`, `/img/antiques/celestial-treasure-fragments.png`.
...
Обе иконки фрагментов сохраняют полное изображение из игры: внутренний скруглённый квадрат с сундуком, рамкой, фоном и белой деталью пазла. Внешнее поле исходного снимка не входит в PNG; карточки показывают эти локальные ассеты через существующий `AppImage` boundary.
