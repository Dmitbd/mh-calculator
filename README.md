...
- [Билды героев](docs/hero-builds-spec.md) — фильтруемый каталог опубликованных билдов с экипировкой, пробуждением оружия, скиллами и деревом божественности.
- [Билдер билдов](docs/divinity-branch-builder-spec.md) — административное создание, сохранение черновиков, публикация и обновление билдов.
